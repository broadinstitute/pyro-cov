...
def main(args):
    ...
    configs = []
    empty_holdout = ()
    empty_backtesting_max_day = None
    ...
    for config in configs:
        ...
        # Backtesting max day is -2
        backtesting_max_day = config[-2]
        #dataset = load_data(args, end_day = backtesting_max_day, **holdout)
