...
for clade in lineage_to_clade['B.1.1.7']:
    print("B.1.1.7:", clade)

alpha = np.array([0 if clade not in lineage_to_clade['B.1.1.7'] else 1 for clade in clades], dtype=bool)
